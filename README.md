...
## Development environment and release process
 ...
 - create virtualenv with Flask and simplq installed into it (latter is installed in
...
install it (`pip install simpleq.tar.gz`), ensure that configuration file exists and
`SIMPLEQ_SETTINGS` environment variable points to it, ensure that user has access to the
